...
__all__ = ['MeshViewerQt']

_icon = os.path.dirname(__file__) + '/_resources/icon.png'


class MeshViewerQt(ShapeViewerQt):
    """
    ...
    def display_mesh(self, mesh, mode=2, group=None,
        ...
        self.view.my_context.Display(mesh_vs, True)
        return mesh_vs

    def add(self, entity, rgb=None, transparency=None, material=Graphic3d_NOM_DEFAULT, mode=2):
        """
        ...
        if isinstance(entity, (SMESH_Mesh, SMESH_subMesh)):
            ...
            return super().add(entity, rgb, transparency, material)
